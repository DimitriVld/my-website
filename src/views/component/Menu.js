  ...
  return(
    <div className={'c-menu'} >
      <nav className='c-menu-nav'>
        ...
        <Link to='/works' className={'c-menu-link ui-h1'} onClick={() => props.funcToggleMenu()}><span>02</span>My works</Link>
        <Link to='/services' className={'c-menu-link ui-h1'} onClick={() => props.funcToggleMenu()}><span>03</span>My Services</Link>
        <Link to='/about-us' className={'c-menu-link ui-h1'} onClick={() => props.funcToggleMenu()}><span>04</span>About</Link>
